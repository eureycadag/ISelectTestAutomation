module.exports = {
    tags: ['spqa_sp_652_ac3', 'spqa_sp_652', 'sp_652', 'spqa_hncconsultant_sp_652_ac3', 'spqa_hncconsultant_sp_652', 'hncconsultant_sp_652'],
    ...
    'GIVEN I have navigated to view the person account page': function(browser) 
    {
        search
            .waitForElementVisible('@searchField', 10000, function (result)
            {
                ...
                {
                    search
                        .setValue('@searchField', energy.hnc.account_info.first_name)
                    browser
            ...
            .waitForElementVisible('@detailsTab', 20000, function (result)
            {
                if (result.value)
                {
                    ...
                    account
                        ...
                        .setValue('@detailsEmail', energy.hnc.account_info.email )
                        .pause(1000)
                    browser
                    ...
                    account
                        ...
                        .setValue('@detailsfirstName', energy.hnc.account_info.first_name )
                        .verify.elementPresent('@detailslastName', 'Last Name Details Field is Present ?')
                        .clearValue('@detailslastName')
                        .setValue('@detailslastName', energy.hnc.account_info.last_name )
                        .pause(2000)
                    browser
    ...
    'THEN I shall be able to ensure that any required fields are populated and/or updated correctly': function (browser) 
    {
        account
            .waitForElementVisible('@detailsTab', 15000, function(result)
            {
                ...
                {
                    account
                        .verify.containsText('@detailsInfo', energy.hnc.account_info.account_name , 'The Details Contains Correct Account Name ?')
                        .verify.containsText('@detailsinfoEmail', energy.hnc.account_info.email , ' The Details Contains Correct Email ?')
                    browser
