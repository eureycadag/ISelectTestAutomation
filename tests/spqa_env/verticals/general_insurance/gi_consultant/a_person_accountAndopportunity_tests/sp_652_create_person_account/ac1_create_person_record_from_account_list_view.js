module.exports = {
    tags: ['spqa_sp_652_ac1', 'spqa_sp_652', 'sp_652', 'spqa_giconsultant_sp_652_ac1', 'spqa_giconsultant_sp_652', 'giconsultant_sp_652'],
    ...
    'THEN a new person account is created':function (browser)
    {
        account
                ...
                if (result.value)
            {
                ...
                account
                    .verify.containsText('@tabTitle', energy.gi.account_info.account_name, 'The account is Opened in a new tab ?')
            }
                else
                {
                    console.log('Refreshing the page')
                    ...
                    account
                        ...
                        .verify.containsText('@tabTitle', energy.gi.account_info.account_name , 'The account is displayed after refresh ?')
                }
            })
    ...
    'AND I can view that the details that I have entered are correctly populated to the person account': function(browser)
    {
        account
            .waitForElementVisible('@personaccountTitle', 20000, function(result)
            {
                ...
                {
                    account
                        .verify.containsText('@emailPresent', energy.gi.account_info.email , 'The Email field is populated correctly to the Person account?')
                    browser
