module.exports = {
    tags: ['spqa_sp_652_ac2', 'spqa_sp_652', 'sp_652', 'spqa_lifeadviser_sp_652_ac2', 'spqa_lifeadviser_sp_652', 'lifeadviser_sp_652'],
            ...
            .waitForElementPresent('.iframe-parent > iframe:nth-child(1)', 30000, function(result)
            {
                if (result.value)
                {
                    browser
                        ...
                        .frame(0)
                    account
                        .setValue('@inputfirstName', energy.lifeadviser.account_info.first_name)
                        .setValue('@inputEmail', energy.lifeadviser.account_info.email)
                    browser
    ...
    'WHEN I have entered at least the Last Name (optionally First Name, Phone Number, and Email Address) and hit the Save button': function (browser) 
    {
       browser
            .useXpath().waitForElementPresent('/html/body/form/div[1]/div[1]/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[2]/input', 15000, function(result)
            {
                ...
                {
                    browser
                        .useXpath().setValue('/html/body/form/div[1]/div[1]/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[2]/input', energy.lifeadviser.account_info.last_name)
                    browser
                        .useXpath().click('/html/body/form/div[2]/div/div[2]/div/table/tbody/tr[10]/td[1]/a[1]/i/b')
                }
                    else
    ...
    'AND I shall be able to view the person account page tab as a default': function(browser)
    {
        account
            .waitForElementVisible('@selectedTab', 30000, function(result)
            {
                ...
                {
                    account
                        .verify.containsText('@selectedTab', energy.lifeadviser.account_info.account_name , 'The Created Account is Correctly Displayed in a Default Tab ?')    
                }
                    else
                    {
                        console.log('Refreshing the browser ...')
